...
public class CategoryDAO extends SuperDAO {
	...
	//修改类别操作
	public boolean updateCategory(Category category,int userID){
		...
		isSuccess = this.updateToDatabase(tablesName,primaryKeyName,category.getCategory_id(),colunmsMap,userID);
